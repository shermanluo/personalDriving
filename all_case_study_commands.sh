...
## DON
## # far overtaking vs. SimpleOptimizerCar
## python run.py world_highway -x overtaking -t 150 --human SimpleOptimizerCar --robot HierarchicalCar -b 1 -d 3 -o inf --horizon 5 -r 5 -u --init_plan_scheme_r prev_opt --init_plan_scheme_h prev_opt -s all_case_studies/3d_strat_val_prev_opt_hessian_far_overtaking_vs_simple_optimizer_car -n
## # overtaking vs. SimpleOptimizerCar
